  ...
  module RubySaml
    ...
    class Metadata
      ...
      def generate(settings, pretty_print=false, valid_until=nil, cache_duration=nil)
        ...
        meta_doc.context[:attribute_quote] = :quote if settings.double_quote_xml_attribute_values
        meta_doc.context[:prologue_quote] = :quote if settings.double_quote_xml_prologue
