  ...
  include REXML
    ...
    class Authrequest < SamlMessage
      ...
      def create_params(settings, params={})
        ...
        request_doc.context[:prologue_quote] = :quote if settings.double_quote_xml_prologue
      ...
      def create_xml_document(settings)
        ...
        root.attributes["AssertionConsumerServiceIndex"] = settings.assertion_attributes_index unless settings.assertion_attributes_index.nil?
